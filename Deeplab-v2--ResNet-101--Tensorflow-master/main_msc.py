...
def configure():
	...
	flags.DEFINE_integer('grad_update_every', 5, 'gradient accumulation step')
	...
	#log
	flags.DEFINE_string('modeldir', 'msc-model', 'model directory')
	flags.DEFINE_string('logfile', 'msc-log-batch-10.txt', 'training log filename')
	flags.DEFINE_string('logdir', 'msc-log-batch-10', 'training log directory')
...
def main(_):
	...
	config.gpu_options.per_process_gpu_memory_fraction = 1  # 占用GPU90%的显存
