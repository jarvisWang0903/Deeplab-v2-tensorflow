...
def configure():
	...
	flags.DEFINE_integer('test_step', 250000, 'checkpoint number for testing/validation')
	...
	# log
	flags.DEFINE_string('modeldir', 'new-model', 'model directory')
	flags.DEFINE_string('logfile', 'new-log.txt', 'training log filename')
	flags.DEFINE_string('logdir', 'new-log', 'training log directory')
